--Settings
local Icon = 'Impostor' -- Icon Name (Put It In Images Folder)
local Name = "Vs Impostor" -- Window Name
...
function onDestroy()
   ...
   songended = true
   if FNF then
    setPropertyFromClass('lime.app.Application', 'current.window.title', "Friday Night Funkin': "..Name)
   else
